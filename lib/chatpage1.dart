...
class ChatPage1 extends StatefulWidget {
  ...
  ChatPage1({required this.currentWallpaper, required this.updateWallpaperCallback});
...
class _ChatPage1State extends State<ChatPage1> {
  ...
  Widget build(BuildContext context) {
    final chatviewmodel1 = Provider.of<weightmanagement>(context); 
          ...
          children: [
            Expanded(
              child: Stack(
                children: [
                  ListView.builder(
                    itemCount: chatviewmodel1.messages.length,
                    controller: _scrollController,
                    itemBuilder: (context, index) {
                      final message = chatviewmodel1.messages[index];
                      return Align(
                        alignment:
                  ...
                  if (chatviewmodel1.messages.isEmpty)
                    Center(
                      child: Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 24.0),
                        child: Text(
                          'Ask me anything about   Weight Management',
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        if (_controller.text.trim().isNotEmpty) {
                          chatviewmodel1.sendMessage(_controller.text.trim());
                          _controller.clear();
                          _scrollToBottom();
                        }
                      },
